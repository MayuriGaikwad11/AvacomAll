...
public class RRTestCase {
 ...
 //  @Test(priority = 2)
	void MinistryMaster() throws InterruptedException, IOException
	{
		...
		RRMethods.MinistryMaster(driver,test,workbook);
...
//	@Test(priority = 3)
	void RegulatorMaster() throws InterruptedException, IOException
	{
		...
		RRMethods.RegulatorMaster(driver,test,workbook);
...
//	@Test(priority = 4)
	void ActDepartmentMaster() throws InterruptedException, IOException
	{
		...
		RRMethods.ActDepartmentMaster(driver,test,workbook);
