...
public class Mgmt {
	...
	{
	//	String workingDir = System.getProperty("webdriver.chrome.driver","C:/March2022/PerformerPom/Driver/chromedriver.exe");
		extent = new com.relevantcodes.extentreports.ExtentReports("C:\\Users\\Mayuri\\Desktop\\Compliance\\AvacomAll\\Reports\\MgmtBita.html",true);
...
//	@Test(priority = 16)
	...
	//	test.log(LogStatus.INFO, "Test Initiated");
		...
		Thread.sleep(3000);
		int IndustrySpeCritical = Integer.parseInt(CFOcountPOM.clickIndustrySpeCriticalM(driver).getText());	//Reading the High value of Labour compliance
		
		Thread.sleep(1000);
		CFOcountPOM.clickIndustrySpeCriticalM(driver).click();					//Clicking on High bar of Labour  
...
//	@Test(priority = 17)
	void BargraphIndustrySpeHighStatutory() throws InterruptedException
	{
		...
		String PendingReview = CFOcountPOM.clickIndustrySpeHighM(driver).getText();	//Reading the Pending For Review value of Human Resource
		...
		CFOcountPOM.clickIndustrySpeHighM(driver).click();					//Clicking on High bar of Labour  
	...
	//	test.log(LogStatus.INFO, "Test Initiated");
		...
		Thread.sleep(4000);
		int IndustrySpeMedium = Integer.parseInt(CFOcountPOM.clickIndustrySpeMediumM(driver).getText());	//Reading the Medium value of Labour compliance
		CFOcountPOM.clickIndustrySpeMediumM(driver).click();					//Clicking on High bar of Labour  
	...
	void BargraphIndustrySpeLowStatutory() throws InterruptedException
	{
		...
		Thread.sleep(4000);
		int IndustrySpeLow = Integer.parseInt(CFOcountPOM.clickIndustrySpeLowM(driver).getText());	//Reading the Medium value of Labour compliance
		CFOcountPOM.clickIndustrySpeLowM(driver).click();					//Clicking on low bar of Indistry Specific  
	...
	/*	
		...
		*/
		...
		{
			test.log(LogStatus.PASS, "'Indistry Specific  - Low' Count = "+IndustrySpeLow);
