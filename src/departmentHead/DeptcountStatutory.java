...
//	@Test(priority = 7)
	...
	*/
	...
	void rejected_PieChart() throws InterruptedException
	{
		...
		Thread.sleep(4000);
		int inProgressValue = Integer.parseInt(CFOcountPOM.clickRejectedDept(driver).getText());	//Reading value of 'Not Completed'
		Thread.sleep(3000);
		CFOcountPOM.clickRejectedDept(driver).click();									//CLicking on 'Not Completed' count
...
//	@Test(priority = 15)
	...
	//	int Closed_Delayed = Integer.parseInt(CFOcountPOM.clickHumanClosedDelayed(driver).getText());	//Reading the High Risk value of Not Completed compliance
		...
		if(Closed_Delayed > 0)
		{
			...
			Thread.sleep(2000);
			DeptCountPOM.RiskGraphCountRE(driver, test, "Closed Delayed", Closed_Delayed, "Statutory");
		}
		else
		{
		...
		if(Closed_Timely > 0)
		{
			...
			DeptCountPOM.RiskGraphCountRE(driver, test, "Closed Timely", Closed_Timely, "Statutory");
		}
		else
		{
	...
	/*	try
		{
			...
			if(Not_Applicable > 0)
			{
				...
				DeptCountPOM.RiskGraphCountRE(driver, test, "Not Applicable", Not_Applicable, "Statutory");
			}
			else
			{
...
/*	
	...
	void ComplianceDocuments() throws InterruptedException, IOException
	{
		...
		DeptCountPOM.complianceDocuments(test,driver);
				extent.endTest(test);
				extent.flush();
	}
